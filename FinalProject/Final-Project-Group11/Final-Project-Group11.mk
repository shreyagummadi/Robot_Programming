...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)src/LandBasedRobot $(IncludeSwitch)src/LandBasedTracked $(IncludeSwitch)src/LandBasedWheeled $(IncludeSwitch)src/Algorithm $(IncludeSwitch)src/API $(IncludeSwitch)src/History $(IncludeSwitch)src/Maze $(IncludeSwitch)src/Byte $(IncludeSwitch)src/Assert $(IncludeSwitch)src/Direction 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
...
## Objects
##
$(IntermediateDirectory)/src_History_history.cpp$(ObjectSuffix): src/History/history.cpp $(IntermediateDirectory)/src_History_history.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ts/UMD/Cu_Ag_Au/FinalProject/Final-Project-Group11/src/History/history.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_History_history.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_History_history.cpp$(DependSuffix): src/History/history.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_History_history.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_History_history.cpp$(DependSuffix) -MM src/History/history.cpp

$(IntermediateDirectory)/src_History_history.cpp$(PreprocessSuffix): src/History/history.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_History_history.cpp$(PreprocessSuffix) src/History/history.cpp
