...
## Objects
##
$(IntermediateDirectory)/src_api.cpp$(ObjectSuffix): src/api.cpp $(IntermediateDirectory)/src_api.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ts/UMD/Cu_Ag_Au/FinalProject/Final-Project-Group11/src/api.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_api.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_api.cpp$(DependSuffix): src/api.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_api.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_api.cpp$(DependSuffix) -MM src/api.cpp

$(IntermediateDirectory)/src_api.cpp$(PreprocessSuffix): src/api.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_api.cpp$(PreprocessSuffix) src/api.cpp
